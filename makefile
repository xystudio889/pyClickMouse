...
clickmouse: gui/main.py
	...
	$(command) --file-description="Clickmouse install" --product-name="CmInit" --windows-icon-from-ico=gui/res/icons/clickmouse/init.ico --file-version="2.1.6.9" gui/init.py  --enable-plugin=pyside6 --windows-console-mode="disable" --windows-uac-admin --output-dir=bin/
